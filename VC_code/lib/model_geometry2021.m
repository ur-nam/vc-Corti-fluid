function MP = model_geometry2021(MP, loc, opt_lgradient)
...
% #  
    ...
    % Apical part 'A' targets 10 mm from stapes
        ...
        MP.thick_PC = coef.thick_PC_A*2;    % diameter of pillar cell, Kikuchi et al., 1991 inferred from # of microtubules
        ...
        MP.tilt_OHC = 2;    % # of cell spacing between OHC and DC process tops    
...
%         MP.thick_PC = coef.thick_PC_B*8;    % diameter of pillar cell
        ...
        MP.tilt_OHC = 2;    % tilt_OHC=2, two cell spacing between OHC and DC process tops
