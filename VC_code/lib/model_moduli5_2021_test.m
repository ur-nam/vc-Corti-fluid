function El = model_moduli5_2021_test(El, Nd, MP)
% # 
...
%     El.type(eDCb) = -0.2;
    ...
    El.YM(eOHC) = coef.e_OHC*15e3; El.SM(eOHC) = 0.3*El.YM(eOHC);

       
    El.YM(eDCb) = coef.hinge_ratio*coef.e_DCb*20e3; El.SM(eDCb) = 0.3*El.YM(eDCb);
    El.YM(eDCbc) = (1-coef.hinge_ratio)*coef.e_DCb*20e3; El.SM(eDCbc) = 0.3*El.YM(eDCbc);
...
%         C.YM_RLx1 = coef.e_RLx1*5*100e6;   C.SM_RLx1 = 0.3*C.YM_RLx1;        
        C.YM_RLx1 = coef.e_RLx1*500e6;   C.SM_RLx1 = 0.3*C.YM_RLx1; 
